...
NN_FRAMEWORK.Pagings = function(){
    ...
    {
        loadPaging("api/product_new.php?perpage=8",'.paging-product');
    }
    /* Categories */
    ...
    /*if(isExist($(".title-spcat")))
    {
        $(".title-spcat li").click(function () {
            $(this).parents(".title-spcat").find("li.active").removeClass("active");
            $(this).addClass("active");

            var list = $(this).data("list");
            var cat = $(this).data("cat");
            loadPaging("api/product.php?perpage=8&idList="+list+"&idCat="+cat+"&type=san-pham",'.paging-product-category-'+list);
            
        })
        $(".title-spcat").each(function(){
