...
<div class="taikhoan">
    <div class="btn-themmoi">
        ...
        <a class="btn btn-sm bg-gradient-secondary" id="delete-all" href="{{route('taikhoan.index')}}" title=""><i
                class="fas fa-redo mr-2"></i>Quay lại</a>
        <!-- Topbar Search -->
        <div class="form-inline form-search d-inline-block align-middle ml-3">
            <form action="">
                <div class="input-group input-group-sm">
                    <input class="form-control form-control-navbar text-sm" name="key" placeholder="Nhập địa chỉ email"
                        aria-label="Tìm kiếm">
