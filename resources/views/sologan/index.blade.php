...
@section('sidebar')
    @parent
    <form class="validation-form" novalidate="" method="post" action="index.php?com=static&amp;act=save&amp;type=slogan" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                                ...
                                <div class="card-body card-article">
                                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                                        ...
                                                        <input type="text" class="form-control for-seo text-sm" name="data[namevi]" id="namevi" placeholder="Tiêu đề (vi)" value="Lorem ipsum, or lipsum as it is sometimes known" required="">
                                                    </div>
                                                                                                                                                                                            </div>
                                                                            </div>
                                </div>
    ...
    <input type="hidden" name="hash" value="vZeTxjelfE"></form>
</section>
