...
<ul class="background navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('sanPham.index')}}"> <i class="far fa-caret-square-right"></i>
                    Sản phẩm</a>
                >>>>>>> fef98cdcc92b1284d14f677aed31bae20067ba49
            </div>
        </div>
    </li>
    <hr class="sidebar-divider my-0">
    ...
    {{(request()->is('tinhnangdb')) ? 'active' : '' }} {{(request()->is('thietke')) ? 'active' : '' }} {{(request()->is('mausac')) ? 'active' : '' }}">
                ...
                <div id="chitietsanpham" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('camera.index')}}"> <i
                                class="far fa-caret-square-right"></i> Camera</a>
                        <a class="collapse-item" href="{{route('RAM.index')}}"> <i
                                class="far fa-caret-square-right"></i> Ram</a>
                        <a class="collapse-item" href="{{route('ROM.index')}}"> <i
                                class="far fa-caret-square-right"></i> Rom</a>
                        <a class="collapse-item" href="{{route('manhinh.index')}}"> <i
                                class="far fa-caret-square-right"></i> Màn hình</a>
                        <a class="collapse-item" href="{{route('hieunangpin.index')}}"> <i
                                class="far fa-caret-square-right"></i> Hiệu năng & Pin</a>
                        <a class="collapse-item" href="{{route('hedieuhanh.index')}}"> <i
                                class="far fa-caret-square-right"></i> Hệ điều hành</a>
                        <a class="collapse-item" href="{{route('tinhnangdb.index')}}"> <i
                                class="far fa-caret-square-right"></i> Tính năng</a>
                        <a class="collapse-item" href="{{route('thietke.index')}}"> <i
                                class="far fa-caret-square-right"></i> Thiết kế</a>
                        <a class="collapse-item" href="{{route('mausac.index')}}"> <i
                                class="far fa-caret-square-right"></i> Màu sắc</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider my-0">
            <<<<<<< HEAD <!-- hóa đơn -->
                ...
                <li
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="{{route('hoadon')}}"> <i
                                    class="far fa-caret-square-right"></i> Hóa
                                đơn</a>
                            <a class="collapse-item" href="{{route('cthoadon')}}"> <i
                                    class="far fa-caret-square-right"></i> Chi
                                tiết hóa đơn</a>
                        </div>
                    </div>
                </li>
                ...
                <<<<<<< HEAD <!-- tĩnh -->
                    ...
                    <li
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="{{route('sologan')}}"> <i
                                        class="far fa-caret-square-right"></i>
                                    Slogan</a>
                                <a class="collapse-item" href="{{route('gioithieu.index')}}"> <i
                                        class="far fa-caret-square-right"></i>
                                    Giới thiệu</a>
                    ...
                    <<<<<<< HEAD <!-- tĩnh -->
                        <li class="nav-item">
                            <a class="nav-link collapsed" data-toggle="collapse" data-target="#collapseTwo1"
                                ...
                                <!-- tĩnh -->
                        <li
                            class="nav-item {{(request()->is('logo')) ? 'active' : '' }} {{(request()->is('slideshow')) ? 'active' : '' }}">
                            <a class="nav-link collapsed" data-toggle="collapse" data-target="#collapseTwo1"
                                aria-expanded="false" aria-controls="collapseTwo1">
                                >>>>>>> fef98cdcc92b1284d14f677aed31bae20067ba49
                            ...
                            <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo"
                                data-parent="#accordionSidebar" style="">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <a class="collapse-item" href="{{route('slideshow')}}"> <i
                                            class="far fa-caret-square-right"></i>
                                        SlideShow</a>
                        ...
                        <hr class="sidebar-divider my-0">
                        <<<<<<< HEAD <li class="nav-item">
                            <a class="nav-link collapsed" data-toggle="collapse" data-target="#tintuc"
                                ...
                                <li
                                    ...
                                    <div id="tintuc" class="collapse" aria-labelledby="headingTwo"
                                        data-parent="#accordionSidebar" style="">
                                        <div class="bg-white py-2 collapse-inner rounded">
                                            <a class="collapse-item" href="{{route('tinTuc.index')}}"> <i
                                                    class="far fa-caret-square-right"></i> Tin
                                                tức</a>
                                            <a class="collapse-item" href="{{route('chinhSach.index')}}"> <i
                                                    class="far fa-caret-square-right"></i>
                                                Chính sách</a>
