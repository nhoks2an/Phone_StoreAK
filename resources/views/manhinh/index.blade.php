...
<div class="taikhoan">
    <div class="btn-themmoi">
        <a class="btn btn-sm bg-gradient-primary text-white" href="{{route('manhinh.create')}}" title="Thêm mới"><i class="fas fa-plus mr-2"></i>Thêm mới</a>
        ...
        <a class="btn btn-sm bg-gradient-secondary" id="delete-all" href="{{route('manhinh.index')}}"
   ...
   <div class="card card-primary card-outline text-sm mb-0">
    <div class="card-header">
        ...
        <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="align-middle text-center text-md text-nowrap">
                                ...
                                <button type="submit" class="btnxoa text-danger" style="background: none;border: none;" value="{{$manhinh->id}}">
            ...
            @foreach($lstmanhinh as $manhinh)
              <!-- modal -->
              <div class="modal fade" id="ManHinhModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
