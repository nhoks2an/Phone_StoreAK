                            ...
                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                                ...
                                <div class="form-group-category row">
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <select id="id_list" name="data[id_list]" data-level="0" data-type="san-pham" data-table="#_product_cat" data-child="id_cat" class="form-control select2 select-category select2-hidden-accessible" data-select2-id="id_list" tabindex="-1" aria-hidden="true"><option value="0" data-select2-id="2">Chọn màu</option><option value="4" data-select2-id="4">Tiêu đề tên vấy cưới</option><option value="3" data-select2-id="5">áo polo</option><option value="2" data-select2-id="6">Áo Thun</option></select></span>
                                    </div> 
                                </div>  
                            </div>
                        </div>
