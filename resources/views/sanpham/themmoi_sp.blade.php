                                ...
                                <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel"
                                    ...
                                    <div class="form-group-category row">
                                        <div class="form-group col-xl-6 col-sm-4">
                                            ...
                                            <<<<<<< HEAD <select id="id_list" name="data[id_list]" data-level="0"
    ...
    <div class="col-xl-4">
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <select id="id_list" name="tenloaisp" data-level="0" data-type="san-pham"
                    class="form-control select2 select-category select2-hidden-accessible" data-select2-id="id_list"
            ...
            <div class="form-group col-xl-6 col-sm-4">
                <label class="d-block" for="id_list">Hãng:</label>
                <select id="id_list" name="tenhang" data-level="0" data-type="san-pham"
                    class="form-control select2 select-category select2-hidden-accessible" data-select2-id="id_list"
                    tabindex="-1" aria-hidden="true">
                    <option value="0" data-select2-id="2">Chọn hãng</option>
        ...
        <div class="card-body">
            <div class="photoUpload-zone">
                <div class="photoUpload-detail" id="photoUpload-preview">
                    <<<<<<< HEAD <img class="rounded" src="" alt="">
                </div>
                <img class="rounded" src="../img/noimage.jpg" alt="">
            </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"
                                    ...
                                    name="soluong" id="numb" placeholder="Số thứ tự" value="1">
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control format-price regular_price text-sm"
                                            name="giacu" id="regular_price" placeholder="Giá bán" value="">
                                        <div class="input-group-append">
                                            <div class="input-group-text"><strong>VNĐ</strong></div>
                                        </div>
                                    </div>
