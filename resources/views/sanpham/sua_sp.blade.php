                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control for-seo text-sm" name="tensanpham" id="namevi" placeholder="Tiêu đề (vi)" value="{{$sanPham->tensanpham}}" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control for-seo text-sm " name="mota" id="descvi"
                                            rows="5" placeholder="Mô tả (vi)">{{$sanPham->mota}}</textarea>
                                            @if($errors->has('mota'))
                                        <div class="alert alert-danger" style="margin-top:10px;">
                                            {{$errors->first('mota')}}
                                        </div>
                                    ...
                                    <div class="form-group-category row">
                                        <div class="form-group col-xl-6 col-sm-4">
                                            ...
                                            <select id="id_list" name="id_camera" data-level="0"
                                                ...
                                                <option value="{{$camera->id}} " @if($sanPham->id_camera == $camera->id) selected @endif >{{$camera->tencamera}}</option>
                                                @endforeach
                                                </select></span>
                                        </div>
                                        <div class="form-group col-xl-6 col-sm-4">
                                            ...
                                            <select id="id_list" name="id_manhinh" data-level="0"
                                                ...
                                                <option value="{{$manhinh->id}}"  @if($sanPham->id_manhinh == $manhinh->id) selected @endif >{{$manhinh->thongso}}</option>
                                                @endforeach
                                                </select></span>     
                                        </div>
                                    </div>
                                    <div class="form-group-category row">
                                        <div class="form-group col-xl-6 col-sm-4">
                                            ...
                                            <select id="id_list" name="id_ram" data-level="0"
                                                ...
                                                <option value="{{$RAM->id}}" @if($sanPham->id_ram == $RAM->id) selected @endif >{{$RAM->soram}}</option>
                                                @endforeach
                                            </select></span>
                                        </div>
                                        <div class="form-group col-xl-6 col-sm-4">
                                            ...
                                            <option value="{{$ROM->id}}" @if($sanPham->id_rom == $ROM->id) selected @endif >{{$ROM->sorom}}</option>
                                            @endforeach
                                            </select></span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group-category row">
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <select id="id_list" name="id_hedieuhanh" data-level="0"
                                            ...
                                            <option value="{{$hedieuhanh->id}}"  @if($sanPham->id_hedieuhanh == $hedieuhanh->id) selected @endif >{{$hedieuhanh->tenhedieuhanh}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <select id="id_list" name="id_tinhnangdb" data-level="0" data-type="san-pham"
                                            ...
                                            <option value="{{$tinhnangdb->id}}"  @if($sanPham->id_tinhnangdb == $tinhnangdb->id) selected @endif >{{$tinhnangdb->tentinhnang}}</option>
                                            @endforeach
                                        </select></span>
                                    </div>
                                </div>
                                <div class="form-group-category row">
                                    ...
                                    <label class="d-block" for="id_list">Thiết kế:</label>
                                        <select id="id_list" name="id_thietke" data-level="0" data-type="san-pham"
                                            ...
                                            <option value="{{$thietke->id}}"  @if($sanPham->id_thietke == $thietke->id) selected @endif >{{$thietke->ten}}</option>
                                            @endforeach
                                        </select></span>    
                                    </div>
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <select id="id_list" name="id_hieunangpin" data-level="0" data-type="san-pham"
                                            ...
                                            <option value="{{$hieunangpin->id}}"  @if($sanPham->id_hieunangpin == $hieunangpin->id) selected @endif >{{$hieunangpin->tenhieunang}}</option>
                                            @endforeach
                                        </select></span>
                                    </div>
                                    <div class="form-group col-xl-6 col-sm-4">
                    ...
                    <div class="form-group-category row">
                        ...
                        <label class="d-block" for="id_list">Màu sắc:</label>
                            <select id="id_list" name="id_mau" data-level="0" data-type="san-pham"
                                ...
                                <option value="{{$mau->id}}"  @if($sanPham->id_mau == $mau->id) selected @endif >{{$mau->tenmau}}</option>
                                @endforeach
                                </select></span>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="photoUpload-zone">
                    <div class="photoUpload-detail" id="photoUpload-preview">
                        <img class="rounded" src="/storage/{{$sanPham->hinhanh}}" alt="Alt Photo" id="hinhanh"></div>
    ...
    <div class="card card-primary card-outline text-sm">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-mini d-inline-block align-middle text-sm" min="1" name="soluong" id="numb" placeholder="Số thứ tự" value="{{$sanPham->soluong}}">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control format-price regular_price text-sm" name="giacu" id="regular_price" placeholder="Giá bán" value="{{$sanPham->giacu}}">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control format-price sale_price text-sm" name="giamoi" id="sale_price" placeholder="Giá mới" value="{{$sanPham->giamoi}}">
                        <div class="input-group-append">
                            <div class="input-group-text"><strong>VNĐ</strong></div>
                        </div>
                    </div>
