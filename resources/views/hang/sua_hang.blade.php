                        ...
                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control for-seo text-sm" name="data[hoten]" id="hoten" placeholder="Tên hãng" value="" required="">
                                </div>
                                <div class="form-group">
                                    <label for="namevi"> Địa chỉ:</label>
                                    <input type="text" class="form-control for-seo text-sm" name="data[hoten]" id="hoten" placeholder="Địa chỉ" value="" required="">
                                </div>
