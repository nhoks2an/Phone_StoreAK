<div class="header">
	<div class="center-layout">
		<div class="header-top flex">
			<div class="title-banner"><marquee>Chào mừng bạn đến với website AK Phone</marquee></div>
			<div class="btn-ac">
				<ul>
				...
				<div class="regions_search">
					<div id="search" class="search search-contain s_close fr">
						<div class="search-content">
							<form name="search_form" id="search_form" method="get" onsubmit="javascript: submit_form_search();return false;">
