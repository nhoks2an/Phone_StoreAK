		...
		<div class="row">
				...
				<div class="top-cart col-12 col-lg-7">
					...
					<div class="list-procart">
							...
							<div class="procart procart-7a53928fa4dd31e82c6ef826f341daec">

								<div class="form-row">

									<div class="pic-procart col-3 col-md-2">

										<a class="text-decoration-none" href="nuoc-rua-chen-rua-tay-bo-hon-chai-500-ml-7" target="_blank" title="Nước Rửa Chén – Rửa Tay Bồ Hòn Chai 500 ml">

											<img src="../images/oppoa5.jpg" alt="">
										</a>

										<a class="del-procart text-decoration-none" data-code="7a53928fa4dd31e82c6ef826f341daec">
									...
									<div class="info-procart col-6 col-md-5">
										...
										<h3 class="name-procart"><a class="text-decoration-none" href="nuoc-rua-chen-rua-tay-bo-hon-chai-500-ml-7" target="_blank" title="Nước Rửa Chén – Rửa Tay Bồ Hòn Chai 500 ml">Nước Rửa Chén – Rửa Tay Bồ Hòn Chai 500 ml</a></h3>
									...
									<div class="quantity-procart col-3 col-md-2">
										...
										<div class="price-procart price-procart-rp">
												...
												<p class="price-new-cart load-price-7a53928fa4dd31e82c6ef826f341daec">
						                ...
						                <div class="quantity-counter-procart quantity-counter-procart-7a53928fa4dd31e82c6ef826f341daec d-flex align-items-stretch justify-content-between">

					                        <span class="counter-procart-minus counter-procart">-</span>

					                        <input type="number" class="quantity-procart" min="1" value="2" data-pid="8" data-code="7a53928fa4dd31e82c6ef826f341daec">
							...
							<div class="procart procart-e5841df2166dd424a57127423d276bbe">

								<div class="form-row">

									<div class="pic-procart col-3 col-md-2">

										<a class="text-decoration-none" href="nuoc-rua-chen-rua-tay-bo-hon-chai-500-ml-6" target="_blank" title="Nước Rửa Chén – Rửa Tay Bồ Hòn Chai 500 ml">

											<img src="../images/oppoa5.jpg" alt="">
										</a>

										<a class="del-procart text-decoration-none" data-code="e5841df2166dd424a57127423d276bbe">
									...
									<div class="info-procart col-6 col-md-5">
										...
										<h3 class="name-procart"><a class="text-decoration-none" href="nuoc-rua-chen-rua-tay-bo-hon-chai-500-ml-6" target="_blank" title="Nước Rửa Chén – Rửa Tay Bồ Hòn Chai 500 ml">Nước Rửa Chén – Rửa Tay Bồ Hòn Chai 500 ml</a></h3>
									...
									<div class="quantity-procart col-3 col-md-2">
										...
										<div class="price-procart price-procart-rp">
												...
												<p class="price-new-cart load-price-new-e5841df2166dd424a57127423d276bbe">

													500.000đ
												</p>

												<p class="price-old-cart load-price-e5841df2166dd424a57127423d276bbe">
						                ...
						                <div class="quantity-counter-procart quantity-counter-procart-e5841df2166dd424a57127423d276bbe d-flex align-items-stretch justify-content-between">

					                        <span class="counter-procart-minus counter-procart">-</span>

					                        <input type="number" class="quantity-procart" min="1" value="1" data-pid="7" data-code="e5841df2166dd424a57127423d276bbe">
			        ...
			        <div class="money-procart">
				        ...
				        <div class="total-procart d-flex align-items-center justify-content-between">
				        	...
				        	<p class="total-price load-price-total">500.000đ</p>
				    ...
				    <div class="section-cart">
				    	...
				    	<div class="information-cart">
				    			...
				    			<div class="payments-cart custom-control custom-radio">
									...
									<input type="radio" class="custom-control-input" id="payments-16" name="dataOrder[payments]" value="16" required="">

									<label class="payments-label custom-control-label active" for="payments-16" data-payments="16">Thanh toán sau khi nhận hàng</label>
				    			...
				    			<div class="payments-cart custom-control custom-radio">
									...
									<input type="radio" class="custom-control-input" id="payments-15" name="dataOrder[payments]" value="15" required="">

									<label class="payments-label custom-control-label" for="payments-15" data-payments="15">Thanh toán trực tuyến</label>
