                ...
                <div class="section-cart">
                    ...
                    <div class="information-cart">
                        ...
                        <div class="payments-cart custom-control custom-radio">
                            ...
                            <input type="radio" class="custom-control-input" id="payments-16" name="dataOrder[payments]"
                                value="16" required="">
                        ...
                        <div class="payments-cart custom-control custom-radio">
                            ...
                            <input type="radio" class="custom-control-input" id="payments-15" name="dataOrder[payments]"
                                value="15" required="">
                    ...
                    <div class="information-cart">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-cart col-md-6">
                                ...
                                <input type="text" class="form-control text-sm" id="fullname" name="dataOrder[fullname]"
                            ...
                            <div class="input-cart col-md-6">
                                ...
                                <input type="number" class="form-control text-sm" id="phone" name="dataOrder[phone]"
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-cart col-md-4">
                                ...
                                <select class="select-district-cart select-district custom-select text-sm" required=""
                                    id="district" name="dataOrder[district]">
                            ...
                            <div class="input-cart col-md-4">
                                ...
                                <select class="select-ward-cart select-ward custom-select text-sm" required="" id="ward"
                                    name="dataOrder[ward]">
