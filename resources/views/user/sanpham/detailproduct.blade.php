                    ...
                    <ul class="attr-pro-detail">
                        ...
                        <div class="product-option color">
                            ...
                            <div class="options" id="colorOptions" style="margin-top: 10px;">
                                ...
                                <form method="post" action="{{route('loadding.loadmau',[$mp->id_ram])}}"
                                    class="item selected dungluong">
                                    @csrf
                        ...
                        <div class="flex">
                            <a href="{{route('cart.cart',['sanPham'=>$sanPham])}}" class="a-giohang">Thêm vào giỏ
                                hàng</a>
                            <button class="btn-giohang" tyle="submit" style="margin-top:10px">
                                <span href="{{route('cart.cart',$sanPham->id)}}">Đặt hàng</span>
                            </button>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button"
                    role="tab" aria-controls="home" aria-selected="true">Thông tin sản phẩm</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button"
                    role="tab" aria-controls="profile" aria-selected="false">Bình luận</button>
            </li>
        </ul>
