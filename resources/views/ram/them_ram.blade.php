...
@section('sidebar')
    @parent
<form method="post" action="{{route('RAM.store')}}" enctype="multipart/form-data">
    @csrf
    <div class="btn-themmoi">
        <button class="btn btn-sm bg-gradient-primary submit-check" name="themmoi" type="submit">
        ...
        <div class="col-xl-12">
            <div class="card card-primary card-outline text-sm ">
                <div class="card-header">
                    <h3 class="card-title">Thông số Ram</h3>
